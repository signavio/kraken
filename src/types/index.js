...
export const hasEntitySchema = (
  types: ApiTypeMap,
  entityType: EntityType
): boolean => types[entityType].schema instanceof schema.Entity

// Temporary workaround: normalizr 3.x has dropped getIdAttribute
export const getIdAttribute = (types: ApiTypeMap, entityType: EntityType) =>
  'id'
